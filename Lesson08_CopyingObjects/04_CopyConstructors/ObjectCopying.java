...
class Animal {
        ...
        public Animal(Animal origAnimal){
            this.animalSpecies = origAnimal.animalSpecies;
            this.animalFamily = origAnimal.animalFamily;
            this.animalPhylum = origAnimal.animalPhylum;
            this.animalName = origAnimal.animalName;
            this.skills = origAnimal.skills;
            this.animalRider = new Rider(origAnimal.animalRider);
        }
